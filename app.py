...
def create_heatmap(df):
    ...
    fig = px.imshow(
        ...
        y=pivot_table.index,
        # Updated color scheme to highlight higher values with deeper reds
    ...
    fig.update_layout(
        autosize=False,
        width=3200,   # Increase width as needed
...
def main():
    ...
    # Default to the earliest (min_date) and latest (max_date) in the dataset
    ...
    # If the start date is greater than the end date, show error and stop
